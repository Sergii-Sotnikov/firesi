  ...
  return (
    <section className={css.faq}>
      <div className={css.container}>
        <h3 className={css.title}>Є питання? Ми тут, щоб допомогти!</h3>
          ...
          <Accordion.Item value="item-1" className={css.item}>
            ...
            <Accordion.Content className={css.content}>
              <p className={css.faqText}>
                Так, абсолютно! Йому не страшний мороз до -15°C ні спека +60!
                Краще для авто підійде вогнегасник у форматі спрею, зручно
                тримати в бардачку, щоб був під рукою. Ваша безпека на дорозі –
                понад усе.
              </p>
            </Accordion.Content>
          </Accordion.Item>
